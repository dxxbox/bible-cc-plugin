...
| **2** | [总览](2026-06-13-phase-2-capture-pipeline.md) → [2a](../Phase-2/2026-06-14-phase-2a-hook-bridge-config.md) · [2b](../Phase-2/2026-06-14-phase-2b-phase1-detection.md) · [2c](../Phase-2/2026-06-14-phase-2c-phase2-retrospective.md) · [2d](../Phase-2/2026-06-14-phase-2d-hint-system.md) | 采集管线：Hook bridge、Phase 1/2 moment detection、dedup、hint system | 6.5d | Key moment 自动检测、去重、用户可见 hint，每步可追溯 |
