...
| 文件 | 内容 | 状态 |
|------|------|------|
| `05-capture/hook-flow.md` | hook → buffer 数据流：/turn/user, /turn/assistant, /turn/tool | ✅ 完成 |
...
- [`02-interfaces.md`](02-interfaces.md) — `/turn/user`, `/turn/assistant`, `/turn/tool`, `/session/end`, BiBLE import API
